...
class SpatioTemporalConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, bias=False, first_conv=False):
        ...
        if first_conv:
            ...
            self.in1 = nn.InstanceNorm3d(intermed_channels)
    ...
    def forward(self, x):
        x = self.relu(self.in1(self.spatial_conv(x)))
        x = self.relu(self.in2(self.temporal_conv(x)))
...
class SpatioTemporalResBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, downsample=False):
        ...
        if self.downsample:
            ...
            self.downsamplein = nn.InstanceNorm3d(out_channels)
    ...
    def forward(self, x):
        ...
        if self.downsample:
            x = self.downsamplein(self.downsampleconv(x))
